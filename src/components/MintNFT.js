...
const chainConfigs = {
  ...
  Polygon: { chainId: "0x13882", contractAddress: '0x2964b4474485BF1763f1A85AE76b264d2f5A77F1' }, // Polygon Mumbai Testnet
  Binance: { chainId: "0x61", contractAddress: '0xaf41061fBa16EA52b737329a28E9F2E689bbd4AE' }, // Binance Smart Chain Testnet
  Arbitrum: { chainId: "0x66eed", contractAddress: '0xEfb069A0D46b8aa2b311281158705b2eC8bF78D7' } // Arbitrum Sepolia Testnet// its have error in pending 8/11/2024
...
const MintNFT = () => {
  ...
  const getRPCUrl = (chainName) => {
    switch (chainName) {
      case "Ethereum":
        return "https://sepolia.infura.io/v3/64d5a638c6834dddb6a59aa830e93f09"; // Replace with your Infura ID
      case "Polygon":
